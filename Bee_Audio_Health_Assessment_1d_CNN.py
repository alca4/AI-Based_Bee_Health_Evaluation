...
ref_train['sample_name'] = './Downloads/Bee_Audio_Health_Merge_3_Split/TRAIN/'+ref_train['sample_name'].astype(str)+'.wav'

ref_train.columns = ['path', 'labels']
ref_train.head()

import os
cpt = sum([len(files) for r, d, files in os.walk('./Downloads/Bee_Audio_Health_Merge_3_Split/TRAIN')])
print('TRAIN output',cpt)


import os
cpt = sum([len(files) for r, d, files in os.walk('./Downloads/Bee_Audio_Health_Merge_3_Split/VAL')])
print('VAL output',cpt)

import os
cpt = sum([len(files) for r, d, files in os.walk('./Downloads/Bee_Audio_Health_Merge_3_Split/TEST')])
print('TEST output',cpt)

import pandas as pd
ref_val = pd.read_csv("./Downloads/Bee_Audio_Health_Merge_3_Split_Val.csv")
ref_val.head()
ref_val['sample_name'] = './Downloads/Bee_Audio_Health_Merge_3_Split/VAL/'+ref_val['sample_name'].astype(str)+'.wav'
...
# df_final = pd.concat([df,df_noise])
df_final = pd.concat([df,df_noise, df_shift, df_pitch],axis=0,sort=False)
# df_final = pd.concat([df,df_noise, df_shift, df_stretch, df_pitch],axis=0,sort=False)
# df_final = pd.concat([df,df_noise, df_shift, df_pitch, df_stretch, df_speedpitch, df_dyn_change])
# df_final = pd.concat([df,df_noise, df_speedpitch, df_shift,df_pitch, df_dyn_change],axis=0,sort=False)
df_final=df_final.fillna(0)
df_final.head()

# df_mel_final = pd.concat([df_mel])
# df_mel_final = pd.concat([df_mel,df_mel_noise])
df_mel_final = pd.concat([df_mel,df_noise_mel, df_shift_mel, df_pitch_mel],axis=0,sort=False)
# df_mel_final = pd.concat([df_mel,df_noise_mel, df_shift_mel, df_stretch_mel, df_pitch_mel],axis=0,sort=False)
# df_mel_final = pd.concat([df_mel,df_noise_mel, df_shift_mel, df_pitch_mel, df_stretch_mel, df_speedpitch_mel, df_dyn_change_mel])
# df_mel_final = pd.concat([df_mel,df_mel_noise, df_mel_speedpitch, df_mel_shift,df_mel_pitch, df_mel_dyn_change],axis=0,sort=False)
df_mel_final=df_mel_final.fillna(0)
df_mel_final.head()

# df_chroma_final = pd.concat([df_chroma])
# df_chroma_final = pd.concat([df_chroma,df_chroma_noise])
df_chroma_final = pd.concat([df_chroma, df_noise_chroma, df_shift_chroma, df_pitch_chroma],axis=0,sort=False)
# df_chroma_final = pd.concat([df_chroma, df_noise_chroma, df_shift_chroma,df_stretch_chroma,df_pitch_chroma],axis=0,sort=False)
# df_chroma_final = pd.concat([df_chroma,df_noise_chroma, df_shift_chroma, df_pitch_chroma, df_stretch_chroma, df_speedpitch_chroma, df_dyn_change_chroma])
# df_chroma_final = pd.concat([df_chroma, df_noise_chroma,df_speedpitch_chroma, df_shift_chroma,df_pitch_chroma, df_dyn_change_chroma],axis=0,sort=False)
df_chroma_final=df_chroma_final.fillna(0)
df_chroma_final.head()

# df_mfcc_final = pd.concat([df_mfcc])
# df_mfcc_final = pd.concat([df_mfcc,df_mfcc_noise])
df_mfcc_final = pd.concat([df_mfcc, df_noise_mfcc, df_shift_mfcc, df_pitch_mfcc],axis=0,sort=False)
# df_mfcc_final = pd.concat([df_mfcc, df_noise_mfcc, df_shift_mfcc,df_stretch_mfcc,df_pitch_mfcc],axis=0,sort=False)
# df_mfcc_final = pd.concat([df_mfcc,df_noise_mfcc, df_shift_mfcc, df_pitch_mfcc, df_stretch_mfcc, df_speedpitch_mfcc, df_dyn_change_mfcc])
# df_mfcc_final = pd.concat([df_mfcc,df_noise_mfcc,df_speedpitch_mfcc, df_shift_mfcc, df_pitch_mfcc, df_dyn_change_mfcc],axis=0,sort=False)
...
model.add(Conv1D(64, 8, padding='same', input_shape=(df_mfcc_final_normalized.shape[1],1))) # X_train.shape[1] = No. of Columns
...
modeling(df_final_expand, df_final_val_expand, "./Downloads/Bee_Audio_Health_Merge_3_Split/best_model3_stft_4.h5")
# modeling(df_mel_final_expand, df_mel_final_expand_val, "./Downloads/Bee_Audio_Health_Merge_3_Split/best_model3_mel_4.h5")
# modeling(df_chroma_final_expand, df_chroma_final_expand_val, "./Downloads/Bee_Audio_Health_Merge_3_Split/best_model3_chroma_4.h5")
modeling(df_mfcc_final_expand, df_mfcc_final_expand_val, "./Downloads/Bee_Audio_Health_Merge_3_Split/best_model3_mfcc_4.h5")
...
# finaldf_stft = perf( df_final_expand, y_train, "./Downloads/Bee_Audio_Health_Merge_3_Split/best_model3_stft_4.h5", 'Pred_stft')
# finaldf_mel = perf( df_mel_final_expand, y_train, "./Downloads/Bee_Audio_Health_Merge_3_Split/best_model3_mel_4.h5", 'Pred_mel')
# finaldf_chroma = perf( df_chroma_final_expand,y_train, "./Downloads/Bee_Audio_Health_Merge_3_Split/best_model3_chroma_4.h5", 'Pred_chroma')
# finaldf_mfcc = perf( df_mfcc_final_expand,y_train, "./Downloads/Bee_Audio_Health_Merge_3_Split/best_model3_mfcc_4.h5", 'Pred_mfcc')
# finaldf_stft_val = perf( df_final_val_expand, y_val, "./Downloads/Bee_Audio_Health_Merge_3_Split/best_model3_stft_4.h5", 'Pred_stft')
# finaldf_mel_val = perf( df_mel_final_expand_val,y_val, "./Downloads/Bee_Audio_Health_Merge_3_Split/best_model3_mel_4.h5", 'Pred_mel')
# finaldf_chroma_val = perf( df_chroma_final_expand_val, y_val, "./Downloads/Bee_Audio_Health_Merge_3_Split/best_model3_chroma_4.h5", 'Pred_chroma')
# finaldf_mfcc_val = perf( df_mfcc_final_expand_val, y_val, "./Downloads/Bee_Audio_Health_Merge_3_Split/best_model3_mfcc_4.h5", 'Pred_mfcc')

finaldf_stft_test = perf( df_final_test_expand, y_test, "./Downloads/Bee_Audio_Health_Merge_3_Split/best_model3_stft_4.h5", 'Pred_stft')
# finaldf_mel_test = perf( df_mel_final_expand_test, y_test, "./Downloads/Bee_Audio_Health_Merge_3_Split/best_model3_mel_4.h5", 'Pred_mel')
# finaldf_chroma_test = perf( df_chroma_final_expand_test,y_test, "./Downloads/Bee_Audio_Health_Merge_3_Split/best_model3_chroma_4.h5", 'Pred_chroma')
finaldf_mfcc_test = perf( df_mfcc_final_expand_test,y_test, "./Downloads/Bee_Audio_Health_Merge_3_Split/best_model3_mfcc_4.h5", 'Pred_mfcc')
...
modeling(df_final_expand, df_final_val_expand, "./Downloads/Bee_Audio_Health_Merge_3_Split/best_model3_stft_4_2.h5")
# modeling(df_mel_final_expand, df_mel_final_expand_val, "./Downloads/Bee_Audio_Health_Merge_3_Split/best_model3_mel_4.h5")
# modeling(df_chroma_final_expand, df_chroma_final_expand_val, "./Downloads/Bee_Audio_Health_Merge_3_Split/best_model3_chroma_4.h5")
# modeling(df_mfcc_final_expand, df_mfcc_final_expand_val, "./Downloads/Bee_Audio_Health_Merge_3_Split/best_model3_mfcc_4.h5")
...
finaldf_stft_test = perf( df_final_test_expand, y_test, "./Downloads/Bee_Audio_Health_Merge_3_Split/best_model3_stft_4_2.h5", 'Pred_stft')
finaldf_mel_test = perf( df_mel_final_expand_test, y_test, "./Downloads/Bee_Audio_Health_Merge_3_Split/best_model3_mel_4.h5", 'Pred_mel')
finaldf_chroma_test = perf( df_chroma_final_expand_test,y_test, "./Downloads/Bee_Audio_Health_Merge_3_Split/best_model3_chroma_4.h5", 'Pred_chroma')
finaldf_mfcc_test = perf( df_mfcc_final_expand_test,y_test, "./Downloads/Bee_Audio_Health_Merge_3_Split/best_model3_mfcc_4.h5", 'Pred_mfcc')
